// Lucide-style SVG icon library — small, no dependencies.
// Usage: icon('search') returns SVG string; iconEl('search') returns SVG element.
...
const ICONS = {
  ...
  spark:       '<path d="m12 3 1.9 5.7L20 10l-5.1 2.1L13 18l-1.9-5.9L5 10l5.1-1.3z"/>',

  // Stats
  apps:        '<rect x="3" y="3" width="8" height="8" rx="1"/><rect x="13" y="3" width="8" height="8" rx="1"/><rect x="3" y="13" width="8" height="8" rx="1"/><rect x="13" y="13" width="8" height="8" rx="1"/>',
  downloadCount: '<path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M16 17v-6"/><path d="m13 14 3 3 3-3"/><path d="M21 14V8l-6-6H5a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h7"/>',
  database:    '<ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14a9 3 0 0 0 18 0V5"/><path d="M3 12a9 3 0 0 0 18 0"/>',
  trending:    '<polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/>',
  star:        '<path d="m12 2 3.1 6.3 7 1-5 5 1.2 6.9L12 17.7 5.8 21l1.2-6.9-5-5 7-1z"/>',
  ...
  storage:     '<rect x="2" y="4" width="20" height="6" rx="1"/><rect x="2" y="14" width="20" height="6" rx="1"/><circle cx="6" cy="7" r="0.5" fill="currentColor"/><circle cx="6" cy="17" r="0.5" fill="currentColor"/>',
  ...
  news:        '<path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2"/><path d="M18 14h-8M18 18h-8M10 6h8v4h-8z"/>',
  ...
  truck:       '<path d="M16 3H1v13h15zM16 8h4l3 3v5h-7zM5.5 18.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5zM18.5 18.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>',
  ...
  android:     '<path d="M5 16V8a3 3 0 0 1 3-3h8a3 3 0 0 1 3 3v8"/><path d="M7 7l-1-2M17 7l1-2"/><circle cx="9" cy="11" r="0.5" fill="currentColor"/><circle cx="15" cy="11" r="0.5" fill="currentColor"/><path d="M5 16h14v3a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2zM2 11v5M22 11v5"/>',

  // Play-style nav & detail
  ...
  play:        '<path d="M5 3.5v17a1 1 0 0 0 1.5.87l14-8.5a1 1 0 0 0 0-1.74l-14-8.5A1 1 0 0 0 5 3.5z" fill="currentColor" stroke="none"/>',
  ...
  // Social / brand glyphs (use with the "fill" class)
  facebook:    '<path d="M24 12.07C24 5.41 18.63 0 12 0S0 5.41 0 12.07c0 6.02 4.39 11.02 10.13 11.93v-8.44H7.08v-3.49h3.05V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.69.24 2.69.24v2.97h-1.51c-1.49 0-1.96.93-1.96 1.89v2.25h3.33l-.53 3.49h-2.8V24C19.61 23.09 24 18.09 24 12.07z"/>',
  instagram:   '<rect x="2" y="2" width="20" height="20" rx="5.5" ry="5.5"/><circle cx="12" cy="12" r="4.2"/><circle cx="17.4" cy="6.6" r="1.1" fill="currentColor" stroke="none"/>',
  telegram:    '<path d="M23.07 3.36 19.6 19.73c-.26 1.16-.95 1.45-1.92.9l-5.3-3.9-2.56 2.46c-.28.28-.52.52-1.07.52l.38-5.42 9.86-8.9c.43-.38-.09-.6-.67-.22L6.13 12.7l-5.25-1.64c-1.14-.36-1.16-1.14.24-1.69L21.6 1.4c.95-.35 1.78.22 1.47 1.96z"/>',
};

function svg(name, extra = '') {
  const body = ICONS[name] || ICONS.sparkle;
  const cls = extra || 'icon';
  return `<svg class="${cls}" viewBox="0 0 24 24" aria-hidden="true">${body}</svg>`;
}

function iconEl(name, extra = '') {
  const tmp = document.createElement('div');
  tmp.innerHTML = svg(name, extra);
  return tmp.firstElementChild;
}

window.GSIcons = { svg, iconEl, ICONS };
